...
namespace LuaTask
{
    ...
    class LuaService
    {
        ...
        public LuaService(long id, string name, TaskManager manager, LuaEnv env)
        {
            ...
            if (taskManager.LuaEnvInit != null)
            {
                taskManager.LuaEnvInit(luaEnv);
            }
        }
        ...
        static public int SendMessage(RealStatePtr L)
        {
            ...
            if (LuaAPI.lua_type(L, 4) != LuaTypes.LUA_TNUMBER)
                return LuaAPI.luaL_error(L, "param 4 need integer");
        ...
        {
            var lv = (LogLevel)LuaAPI.lua_tonumber(L, 1);
            var logline = LuaAPI.lua_tostring(L, 2);
            var S = ObjectHolder.Get<LuaService>(L, KEY);
    ...
    public class TaskManager
    {
        ...
        public Action<LuaEnv> LuaEnvInit;
        ...
        static int Shutdown(RealStatePtr L)
        {
            var taskManager = ObjectHolder.Get<TaskManager>(L, KEY);
        ...
        static int SetTimeOffset(RealStatePtr L)
        {
        ...
        static int OpenLib(RealStatePtr L)
        {
            ...
            LuaAPI.lua_rawset(L, -3);
            LuaAPI.xlua_pushasciistring(L, "shutdown");
            LuaAPI.lua_pushstdcallcfunction(L, Shutdown);
            LuaAPI.lua_rawset(L, -3);

            LuaAPI.xlua_pushasciistring(L, "set_time_offset");
            LuaAPI.lua_pushstdcallcfunction(L, SetTimeOffset);
            LuaAPI.lua_rawset(L, -3);
